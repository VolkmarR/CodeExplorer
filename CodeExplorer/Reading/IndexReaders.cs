...
public sealed class IndexReaders(ProjectIndexes indexes)
{
    ...
    ///     whose reads threw or were cancelled is closed rather than pooled (<see cref="IndexLease.Completed" />).
    ///     Every lease this class opens is read through here, so no reader can forget to say it.
    /// </summary>
