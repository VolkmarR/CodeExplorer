...
`AllowedHosts` replaces that list, and under either a request with no Host header at all is refused
too. With authentication on or off, `/api` and every MCP endpoint
